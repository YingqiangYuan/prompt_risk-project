...
> Hand-written design rationale by the project author. Treated as the **authoritative source for WHY** by `/learn-this-project-*` skills. If this conflicts with code, prefer this — and tell the user.
