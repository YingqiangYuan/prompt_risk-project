...
- [OWASP Top 10 for LLM Applications (2025)](https://genai.owasp.org/llm-top-10/) — LLM06: Excessive Agency, LLM07: System Prompt Leakage
- [NIST AI Risk Management Framework (AI RMF)](https://www.nist.gov/itl/ai-risk-management-framework) — GenAI Profile
- [ISO/IEC 42001 — AI Management System Standard]()
- [NAIC Model Bulletin on AI in Insurance](https://content.naic.org/sites/default/files/cmte-h-big-data-artificial-intelligence-wg-ai-model-bulletin.pdf.pdf)
- [AWS Prescriptive Guidance on LLM Lifecycle Management](https://docs.aws.amazon.com/pdfs/prescriptive-guidance/latest/gen-ai-lifecycle-operational-excellence/gen-ai-lifecycle-operational-excellence.pdf)
